...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file = [data_root + 'coco_subset_images/annotations/filtered_train.json'],
        img_prefix=[data_root + 'coco_subset_images/coco_carTruck'],
    ...
    val=dict(
        ...
        ann_file=data_root + 'coco_subset_images/annotations/instances_val2017.json',
        img_prefix=data_root + 'coco_subset_images/val2017/',
