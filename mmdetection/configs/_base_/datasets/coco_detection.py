...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        # ann_file = [data_root + 'annotations/filtered_train.json', data_root + 'annotations/car_truck_openImage_train.json'],
        # img_prefix=[data_root + 'new_cartruck/', data_root + 'openImage_carTruck/'], # 아니면 이 이미지들을 new_cartruck폴더에 다 넣자.
